  ...
  const renderList = () => (
    <Box sx={{ p: 2 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3 }}>
        <Typography variant="h6" color="primary" fontWeight="bold">My Book Chapter Publications</Typography>
      ...
      <TableContainer component={Paper} sx={{ borderRadius: 2, boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}>
        <Table>
          <TableHead sx={{ background: "#f5f5f5" }}>
            <TableRow>
              <TableCell sx={{ fontWeight: 600 }}>Text Book Name</TableCell>
              <TableCell sx={{ fontWeight: 600 }}>Chapter Title</TableCell>
            ...
            {(!publicationsList || publicationsList.length === 0) ? (
              ...
              publicationsList.map((pub, i) => (
                <TableRow key={pub._id || i}>
                  <TableCell>{pub.textBookName || "N/A"}</TableCell>
                  <TableCell>{pub.chapterTitle || "N/A"}</TableCell>
    ...
    <FormCard title="Book chapter Submission">
      ...
      <Grid2 sx={{ mt: 1 }}>
        ...
        <Box>
          ...
          <TextField size="small" value="1500" disabled sx={{ "& .MuiInputBase-input.Mui-disabled": { WebkitTextFillColor: "#2e7d32", fontWeight: 700, background: "#e8f5e9" } }} />
        </Box>
      </Grid2>
