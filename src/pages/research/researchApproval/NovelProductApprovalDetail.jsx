        ...
        <Box sx={{ width: "100%", pb: 5 }}>
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3, mb: 3 }}>
                ...
                <Card sx={{ ...cardStyle, flex: { xs: "1 1 100%", lg: "1 1 48%" }, mb: 0 }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <LabelValue label="Entry Type" value={data.entryType === 'Admin' ? 'Entry: R&D Admin' : 'Self (Faculty)'} horizontal />
            ...
            >
                <DialogTitle sx={{ fontWeight: 800, color: decisionMode === 'Reject' ? '#d32f2f' : 'var(--color-primary)' }}>
                    {decisionMode === 'Reject' ? 'Reject Novel Product Request' : 'Approve Novel Product Request'}
                </DialogTitle>
