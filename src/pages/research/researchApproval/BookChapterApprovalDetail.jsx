                                ...
                                <Box sx={{ mb: 3, display: "flex", gap: 2, flexWrap: "wrap" }}>
                                    {data.applyIncentive === 'Yes' && (
                                        <Box sx={{ flex: 1, minWidth: 200 }}>
                                            ...
                                            <TextField fullWidth size="small" type="number" placeholder="Enter approved amount" value={approvedAmount} onChange={e => setApprovedAmount(e.target.value)} sx={{ "& .MuiOutlinedInput-root": { borderRadius: "10px", bgcolor: "var(--bg-panel)" } }} />
                                        </Box>
                                    )}
                                    <Box sx={{ flex: 1, minWidth: 200 }}>
