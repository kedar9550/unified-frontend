...
function Dashboard() {
  ...
  return (
    <PageContainer>
      ...
      {(activeRole === "STUDENT_EVENT_ADMIN" || activeRole === "STUDENTEVENT_ADMIN" || activeRole === "STUDENT EVENT ADMIN" || activeRole === "VEDA_ADMIN" || activeRole === "VEDA ADMIN" || activeRole === "EVENT_COORDINATOR" || activeRole === "FACULTY_COORDINATOR" || activeRole === "ACCOMMODATION_COORDINATOR" || activeRole === "SCHOOL_COORDINATOR") && <StudentEventAdminDashboard />}
