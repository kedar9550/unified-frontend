...
const ITEM_METADATA = {
  ...
  "Feedback Discrepancies": { color: "rgba(153, 27, 27, 0.12)", iconColor: "#ef4444", icon: <Flag /> },
  "Proctoring Discrepancies": { color: "rgba(245, 158, 11, 0.12)", iconColor: "#f59e0b", icon: <Flag /> },
  "Feedback": { color: "rgba(153, 27, 27, 0.12)", iconColor: "#ef4444", icon: <Flag /> },
  "Proctoring": { color: "rgba(245, 158, 11, 0.12)", iconColor: "#f59e0b", icon: <Flag /> },
  ...
  "Appraisal Reports": { color: "rgba(154, 52, 18, 0.12)", iconColor: "#f97316", icon: <Assessment /> },
